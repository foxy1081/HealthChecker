// src/lib.rs
/*
 * Core library for HealthChecker
 */
...
#[derive(Debug)]
pub struct HealthCheckerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HealthCheckerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HealthChecker processing");
    
    let mut processor = HealthCheckerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HealthCheckerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HealthCheckerProcessor::new(false);
